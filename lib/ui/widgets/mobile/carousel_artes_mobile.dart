...
class CarouselArtesMobile extends StatefulWidget {
  const CarouselArtesMobile({super.key});

  @override
  State<CarouselArtesMobile> createState() => _CarouselArtesMobileState();
}

class _CarouselArtesMobileState extends State<CarouselArtesMobile> {
